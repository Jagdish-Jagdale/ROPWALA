...
const NavItem = ({
  ...
  if (hasDropdown) {
      ...
      return (
        <div className={isDropdownOpen ? "" : "mb-2"}>
          <div
            ...
            className={`flex items-center rounded-lg px-4 py-2 gap-3 cursor-pointer transition-all duration-300 ease-in-out transform hover:scale-[1.02] ${
          ...
          >
            <Icon
              ...
              strokeWidth={2}
              className={
                isDropdownOpen || isActive ? "text-green-700" : "text-black"
              }
            />
            <span className="flex-grow text-[16px] font-medium whitespace-nowrap">
              {label}
            </span>
            {isDropdownOpen ? (
              <ChevronUp size={18} />
              ...
              {submenu.map((item) => (
                <NavLink
                  ...
                  className={({ isActive: isSubActive }) =>
                    `flex items-center px-5 py-2 ml-4 rounded-md text-[16px] font-medium transition-all duration-300 ease-in-out transform hover:scale-[1.02] no-underline ${
                      isSubActive
    ...
    // Collapsed Dropdown Statepi
    return (
      <div
        onClick={onToggleDropdown}
        title={label}
        className={`flex items-center justify-center rounded-md transition-all duration-300 ease-in-out transform hover:scale-[1.02] mb-1 cursor-pointer px-2 py-2 ${
          isActive
            ? "bg-gradient-to-r from-green-600 to-emerald-600 text-white shadow-md"
            : "text-black hover:bg-gradient-to-r hover:from-green-50 hover:to-emerald-50 hover:text-green-700 hover:shadow-sm"
        }`}
...
export default function AdminLayout() {
  ...
  return (
    <div
      className="h-screen bg-white font-sans text-gray-900 flex flex-col lg:flex-row overflow-hidden"
      style={{
        fontFamily:
    ...
    >
      ...
      >
        ...
        <div
          className={`hidden lg:flex items-center justify-center border-b border-gray-200/100 relative transition-all duration-300 lg:rounded-t-2xl ${
            collapsed ? "min-h-[80px]" : "min-h-[100px]"
          }`}
        >
          {!collapsed && (
          ...
          <button
            ...
            className={`p-1.5 rounded-lg text-gray-400 hover:text-green-600 transition-all duration-200 hidden lg:flex items-center justify-center ${
              collapsed
          ...
          <div className="flex flex-col gap-2">
            {menuItems.map((item) => (
              <NavItem
                ...
                onToggleDropdown={() =>
                  handleToggleDropdown(item.to || item.label)
                }
        ...
        <div className="border-t border-gray-100 p-2 flex flex-col gap-1">
          <button
            ...
            className={`w-full flex items-center rounded-lg text-emerald-600 hover:bg-emerald-50 transition-colors ${
