        ...
        try {
            ...
            const data = await Promise.all(
                querySnapshot.docs.map(async (d) => {
                    ...
                    const subCategoriesRef = collection(db, "categories", d.id, "sub-categories");
                    const subSnapshot = await getDocs(query(subCategoriesRef, orderBy("createdAt", "asc")));
                        ...
                        <table className="w-full border-separate border-spacing-0">
                            <thead>
                                <tr className="border-b border-gray-200 bg-gray-100 font-sans">
                                    <th className="px-6 py-3 text-center text-xs font-bold text-gray-700 uppercase tracking-wider w-20">Sr No</th>
                                    <th className="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Category</th>
                                    <th className="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Sub-categories</th>
                                    <th className="px-6 py-3 text-center text-xs font-bold text-gray-700 uppercase tracking-wider whitespace-nowrap min-w-[160px]">Add Sub-categories</th>
                                    ...
                                    filteredCategories.map((category, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-3 whitespace-nowrap text-center border-b border-gray-100">
                                                ...
                                                >
                                                    <Plus size={14} className="transition-transform group-hover/sub:scale-110" />
                                                </button>
                                            </td>
                                            <td className="px-6 py-3 whitespace-nowrap text-center border-b border-gray-100">
                            ...
                            <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between">
                                        <label className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Sub-Categories</label>
                                        ...
                                        {selectedCategory.subcategories && selectedCategory.subcategories.length > 0 ? (
                                            selectedCategory.subcategories.map((sub, idx) => (
                                                ...
                                                >
                                                    ...
                                                    <span className="text-[10px] text-gray-400 font-mono italic">Sub-{String(idx + 1).padStart(2, '0')}</span>
                                                </div>
                                            ))
                                        ) : (
                        ...
                        <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden scale-in-center border border-gray-100">
                            <div className="p-5 border-b border-gray-100 flex items-center justify-between bg-gray-50/80">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 className="text-lg font-bold text-gray-900 leading-tight">Add Sub-category</h2>
                                        <p className="text-[11px] text-gray-500 font-medium">Create a nested items list</p>
                                    </div>
                                </div>
                                <button
                            ...
                            <form
                                onSubmit={async (e) => {
                                    ...
                                    try {
                                        const subCategoriesRef = collection(db, "categories", selectedCategory.id, "sub-categories");
                                ...
                                <div className="space-y-4">
                                    <div className="bg-green-50/50 border border-green-100/50 p-3 rounded-xl flex items-center gap-3">
                                        ...
                                        <div className="overflow-hidden">
                                            <p className="text-[10px] uppercase tracking-wider text-green-600 font-bold mb-0.5">Adding to category</p>
                                            <p className="text-sm font-bold text-gray-900 truncate" title={selectedCategory.name}>
                                                {selectedCategory.name?.length > 30 ? selectedCategory.name.substring(0, 30) + "..." : selectedCategory.name}
                                            </p>
                                        </div>
                                    </div>
