...
const BannerImage = ({ src, alt, className = "" }) => {
  ...
  return (
    <div
      className={`relative overflow-hidden bg-gray-50 border border-gray-100 rounded-lg flex items-center justify-center ${className}`}
    >
      {isLoading && !error && (
        ...
        {loading ? (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-20 text-center">
            <div className="flex flex-col items-center justify-center gap-3">
              ...
              <span className="text-base text-gray-500 font-bold tracking-tight">
                {t("banner:loading")}
              </span>
            </div>
          </div>
              ...
              >
                ...
                <div className="p-4 flex items-center justify-between bg-white">
                  <div className="flex items-center gap-2">
                    <span
                      className={`px-3 py-1 text-[10px] font-extrabold rounded-full uppercase tracking-widest ${
                        p.isActive
                    ...
                    >
                      {p.isActive
                        ? t("banner:card.status_active")
                        : t("banner:card.status_inactive")}
                    </span>
                  </div>
          ...
          <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
              <h3 className="text-lg font-bold text-gray-900 flex items-center gap-2">
                ...
                {isAddModalOpen
                  ? t("banner:modals.add_title")
                  : t("banner:modals.edit_title")}
              </h3>
              <button
                onClick={() =>
                  !isSubmitting &&
            ...
            <form
              onSubmit={isAddModalOpen ? handleAddBanner : handleUpdateBanner}
              className="p-6 space-y-6 text-center lg:text-left"
            >
              {/* Image Upload */}
              <div className="space-y-1.5 ">
                <label className="text-xs font-bold text-gray-400 uppercase tracking-wider ml-1">
                  {t("banner:modals.fields.image")}{" "}
                ...
                <div className="p-4 bg-gray-50 border border-gray-200 border-dashed rounded-2xl hover:border-green-400 transition-colors">
                  ...
                  >
                    <Upload size={18} />
                    {imagePreview
                      ? t("banner:modals.placeholders.change")
                      : t("banner:modals.placeholders.upload")}
                  </label>
                </div>
              </div>
